<section class="py-8 antialiased dark:bg-gray-900 md:py-12">
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <livewire:heading-navigation-component />
            ...
            @foreach($room as $room)
                <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    <div class="h-56 w-full overflow-hidden rounded-lg">
                        <a href="#">
                            @if(is_null($room->img))
                                <iframe class="w-full h-full dark:hidden object-cover" src="https://lottie.host/embed/a4c3be28-903f-4676-8d2c-bc59f082e444/uTFX8nrs58.json"></iframe>
                            @else
                                <img class="w-full h-full dark:hidden object-cover" src="{{$room->img}}" alt="Ruangan {{$room->name}}" />
                            @endif
                        </a>
                    </div>
                    <div class="pt-6">
                        <div class="mb-4 flex items-center justify-between gap-4">
                            <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300"> Upcomming Event: 13 July 2024 </span>
...
{{--                            </div>--}}
                        ...
                        <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Ruangan {{$room->name}}</a>
                        ...
                        <div class="mt-4 flex items-center justify-between gap-4">
                            ...
                            <button type="button" class="inline-flex items-center rounded-lg bg-sky-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
