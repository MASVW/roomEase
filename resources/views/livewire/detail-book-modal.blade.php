            ...
            <div class="relative bg-white rounded-lg shadow sm:p-5">
                <div class="flex justify-between items-start p-4 sm:p-5 rounded-t border-b">
                    <h3 class="text-lg font-semibold text-gray-900">
                        Room Reservation Request Detail
                        @if($status == 'approved')
                            <span class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300 capitalize">{{$status}}</span>
                        @elseif($status == 'rejected')
                            <span class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300 capitalize">{{$status}}</span>
                        @else
                            <span class="bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300 capitalize">{{$status}}</span>
                        @endif
                    </h3>
                ...
                <div class="p-4 sm:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-1">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="description" wire:model="eventDescription" disabled rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-sky-500 focus:border-sky-500" placeholder="Write abstract event here"></textarea>
                        </div>
                    </div>
                    <div class="grid gap-4 mb-4 grid-cols-1 sm:grid-cols-2">
                        <div>
                            <div class="relative max-w-sm">
                                ...
                                <input wire:model="start" disabled id="event-start" type="datetime-local" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Select date">
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="relative max-w-sm">
                                ...
                                <input wire:model="end" disabled id="event-end" type="datetime-local" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Select date">
                            </div>
                        </div>
                    </div>
